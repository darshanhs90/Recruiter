...
.accordion div.pane {
 ...
 <script src="js/bootstrap.min.js"></script>
    ...
    <ASIDE ng-repeat="prof in profiles track by $index"> <h3>Student: {{prof.email}} </h3>
    ...
    <div class="pane">
       ...
       <button type="button" class="btn btn-success"  id="btnsbmt" ng-click="setupcall($index)">Setup Voice Call</button>
   		 <button type="button" class="btn btn-success"  id="btnsbmt" ng-click="analyse($index)">Analyse Profile</button>
   		 <button type="button" class="btn btn-success"  id="btnsbmt" ng-click="shortlist($index)">Shortlist</button>
   		 <button type="button" class="btn btn-success"  id="btnsbmt" ng-click="reject($index)">Reject</button>
   		<button type="button" class="btn btn-success"  id="btnsbmt" ng-click="resume($index)">View Resume</button>
